...
export async function Daily(ctx) {
    ...
    try {
        ...
        if (!isDailyOpen()) {
            return send(`⏰ El daily se puede cobrar entre las *8:00 am* y las *9:30 pm*.\n` +
        ...
        if (cooldown && Date.now() < cooldown.getTime()) {
            ...
            return send(`⏳ Ya cobraste tu daily hoy.\n` +
