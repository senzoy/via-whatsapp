...
export async function Multas(ctx: CommandContext) {
  ...
  if (outstanding > 0) {
    lines.push(
      ``,
      `💡 Puedes pagar tus multas trabajando con !work.`,
      `💸 La multa se descuenta de tu wallet primero,`,
      `🏦 luego del banco, y si no alcanza, de tus ganancias.`,
    );
  } else {
